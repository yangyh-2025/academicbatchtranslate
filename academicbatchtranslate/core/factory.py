...
# academicbatchtranslate.core.factory.py

import logging

from academicbatchtranslate.agents.glossary_agent import GlossaryAgentConfig
from academicbatchtranslate.core.schemas import TranslatePayload, MarkdownWorkflowParams, TextWorkflowParams, JsonWorkflowParams, \
...
from academicbatchtranslate.workflow.ass_workflow import AssWorkflowConfig, AssWorkflow
from academicbatchtranslate.workflow.base import Workflow
from academicbatchtranslate.workflow.docx_workflow import DocxWorkflowConfig, DocxWorkflow
from academicbatchtranslate.workflow.epub_workflow import EpubWorkflowConfig, EpubWorkflow
from academicbatchtranslate.workflow.html_workflow import HtmlWorkflowConfig, HtmlWorkflow
from academicbatchtranslate.workflow.json_workflow import JsonWorkflowConfig, JsonWorkflow
from academicbatchtranslate.workflow.md_based_workflow import MarkdownBasedWorkflowConfig, MarkdownBasedWorkflow
from academicbatchtranslate.workflow.pptx_workflow import PPTXWorkflowConfig, PPTXWorkflow
from academicbatchtranslate.workflow.srt_workflow import SrtWorkflowConfig, SrtWorkflow
from academicbatchtranslate.workflow.txt_workflow import TXTWorkflowConfig, TXTWorkflow
from academicbatchtranslate.workflow.xlsx_workflow import XlsxWorkflowConfig, XlsxWorkflow
...
def create_workflow_from_payload(payload: TranslatePayload, logger: logging.Logger = None) -> Workflow:
    ...
    """
    if logger is None:
        logger = logging.getLogger("academicbatchtranslate.factory")
